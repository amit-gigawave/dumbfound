...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className={`${wrap} pb-[clamp(48px,7vw,90px)] pt-[clamp(72px,12vw,150px)]`}>
        ...
        <p className="font-text mt-7 max-w-[52ch] text-[clamp(17px,1.6vw,19px)] leading-relaxed text-stone">
          A gallery of artists and their works — established names and new voices, across
          every medium — each presented with the care of a museum catalogue: who made it,
          what it is, and the story it carries.
        </p>
      ...
      <div className="border-y border-rule">
        <p className={`${wrap} flex flex-wrap gap-x-7 gap-y-2 py-4 text-[13px] text-stone`}>
      ...
      <section className={`${wrap} py-[clamp(64px,8vw,104px)]`}>
        <SectionHeader title="Artists" link={{ label: "All artists", href: "/artists" }} />
      ...
      <section id="featured" className={`${wrap} pb-[clamp(64px,8vw,104px)]`}>
        <SectionHeader title="Featured works" link={{ label: "All artworks", href: "/artworks" }} />
